  ...
  <div class="content">
    <div class="storeCreate-con store-con">
      ...
      <p>
        ...
        <input type="text" name="number" v-model="shopForm.n_times"  id="nTimes" v-validate="'required|number'" >
        <span>倍</span>
      </p>
      <p>
    ...
    <!-- <p class="create-btn btns" @click="$router.push('/myShop')">创建店铺</p> -->
     <div  class="save-shop" v-if="!shopForm.distributor_id"
      :class="['cell-btn',errors.has('name')||errors.has('number')|(shopForm.title.length==0||shopForm.title.length>10)||shopForm.n_times.length==0?'disabled-btn':'']" 
