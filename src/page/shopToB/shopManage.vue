  ...
  <div class="content">
    <div class="storeCreate-con store-con">
      ...
      <p>
        ...
        <input type="text" name="number" v-model="shopForm.n_times"  id="nTimes" v-validate="'required'"  @keyup="trim" @click="focuscodeoneclick" @blur="gotoView" v-focus="focuscodeoneState">
        <span>倍</span>
      </p>
      <p>
