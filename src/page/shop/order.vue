          ...
          <div class="order-list">
            <div class="order-item">
              ...
              <div class="order-product-list">
                ...
                <span style="color:#999;border:1px solid #999" class="payment" v-if="item.post_sales_status==0&&orderDetail.order_status>1&&orderDetail.order_status<5" @click="$router.push('/afterSaleChoice')">退款</span>
