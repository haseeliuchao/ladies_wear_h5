              ...
              <li class="prod-item" v-for="(item,index) in indexRusultData" :key="index" @click= "()=>$router.push('/product/'+item.item_id)">
                ...
                <div class="prod-info">
                  ...
                  <p class="prod-price">
                    ...
                    <span style="margin-left:8px;text-decoration: line-through;color:#999"><em>&yen;</em><em style="font-size:15px;">{{item.sales_price/100.00|topriceafter}}</em>.{{item.sales_price/100.00|topricenext}}</span>
                    </p>
                </div>
              </li>
            </ul>
