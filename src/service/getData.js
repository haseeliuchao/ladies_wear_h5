...
// shopToB
export const getShopList = (params) => new Http().require({api: '/api/distributor/stastistics',param: params}); //B端店铺列表
...
export const getShopPd = (params) => new Http().require({api: '/api/distributor/item/page',param: params}); //B端店铺商品列表
